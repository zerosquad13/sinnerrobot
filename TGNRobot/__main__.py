...
PM_START_TEXT = """
💋 *ʜᴇʟʟᴏ {} !* 🍻 ɪ ᴀᴍ [sıɴɴᴇʀ `sǫᴜʌᴅ](https://telegra.ph/file/16e9fd60a10a093efd2b8.jpg)
...
def zaid_about_callback(update, context):
    ...
    if query.data == "zaid_":
        query.message.edit_text(
            text=""" ℹ️ I am [〝ⵢɪɴ͜͡ɴᴇʀ〞](t.me/zerosuperbot), a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_〝ⵢɪɴ͜͡ɴᴇʀ〞 licensed under the GNU General Public License v3.0_
                 \n❍ Assistant @zeromusicassistant.
                 \nHere is the [💾Repository](https://t.me/lifeinsinn).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I am [〝ⵢɪɴ͜͡ɴᴇʀ〞](t.me/zerosuperbot)
                 \nHere is the [Source Code](https://t.me/lifeinsinn) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
